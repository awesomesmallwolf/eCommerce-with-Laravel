...
<div class="text-right ">
  <a href="/product-option/brand/create" class="btn  btn-lg" style="background-color: rgb(255, 174, 0)"><i class="fas fa-copyright"></i> &nbsp; 
<span class="font-weight-bold">Add Brand</span></a>
</div>
          ...
          @foreach ($data as $item)
              <tr>
                  ...
                  <td>
                        ...
                        <a href="/product-option/brand/{{$item->id}}/edit" class="btn btn-dark">Edit</a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <form action="/product-option/brand/{{$item->id}}" method="POST">
                            @csrf
                            @method("DELETE")
